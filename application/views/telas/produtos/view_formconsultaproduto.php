                        ...
                        <form role="form" action="consultaproduto" method="post"
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="descricaoproduto" class="col-sm-2 control-label">Nom Campagnes</label>
                                ...
                                <div class="form-group">
                                    <label for="codigoean" class="col-sm-2 control-label">Editeur</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-12 col-sm-3 col-lg-3">
                                        <button type="submit" class="btn btn-primary"
                                                style="width: 100%">Consulter Campagne</button>
                                    </div>
                                </div>
                            </div>
                        </form>
