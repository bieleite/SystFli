<div class="content-wrapper">
      <section class="content-header">
            <h1>Ajouter Campagnes</h1>
            <ol class="breadcrumb">
                  <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                  <li>Campagnes</li>
                  <li class="active">Ajouter Campagnes</li>
            </ol>
      </section>
                                    ...
                                    <form role="form" action="cadastraproduto" method="post"
                                          ...
                                          <div class="box-body">
                                                <div class="form-group">
                                                      <label for="descricaoproduto" class="col-sm-2 control-label">Nom Campagne</label>
                                                ...
                                                <div class="form-group">
                                                      <label for="unidade" class="col-sm-2 control-label">Type Campagne</label>
                                                      <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                      <label for="valormercadoria" class="col-sm-2 control-label">Prix Editeur (€)</label>
                                                ...
                                                <div class="form-group">
                                                      <label for="valorvenda" class="col-sm-2 control-label">Prix Annonceur (€)</label>
                                                ...
                                                <div class="form-group">
                                                      <label for="qtdeestoque" class="col-sm-2 control-label">Objectif Client</label>
                                                ...
                                                <div class="form-group">
                                                      <label for="descontopermitido" class="col-sm-2 control-label">Max Discount (%)</label>
                                             ...
                                             <div class="form-group">
                                                      <label for="codigoean" class="col-sm-2 control-label">Société</label>
                                                ...
                                                <div class="form-group">
                                                      ...
                                                      <div class="col-xs-12 col-sm-3 col-lg-3">
                                                            <button type="submit" class="btn btn-primary"
                                                                    style="width: 100%">Ajouter Camapagne</button>
                                                      </div>
                                                </div>
                                          </div>
                                    </form>
